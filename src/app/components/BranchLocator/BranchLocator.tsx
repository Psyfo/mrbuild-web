  ...
  return (
    <section className='bg-mbDark'>
      ...
      <div className='flex flex-col items-center py-[4rem]'>
        ...
        />
        <div className='round border-[3px] border-mbYellow rounded-lg mt-[1rem] px-[4rem] py-[1rem] font-dinot text-[1rem] lg:text-[1.9rem] text-white tracking-[0.04rem]'>
          <div className='mb-[1rem] lg:mb-[2rem]'>Our operating hours are:</div>
          <div className='flex'>
            <span className='w-[8rem] lg:w-[15rem]'>Mon - Fri</span>
            <span>: 07:30 - 13:00, 14:00 - 16:30</span>
          </div>
          <div className='flex'>
            <span className='w-[8rem] lg:w-[15rem]'>Sat</span>
            <span>: 07:30 - 12:30</span>
          </div>

          <div className='flex'>
            <span className='w-[8rem] lg:w-[15rem]'>Sun</span>
            <span>: Closed</span>
          </div>
          <div className='flex'>
            <span className='w-[8rem] lg:w-[15rem]'>Public Holidays</span>
