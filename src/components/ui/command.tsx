...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex items-center data-[selected=true]:bg-accent data-[disabled=true]:opacity-50 px-2 py-1.5 rounded-sm outline-none text-sm data-[selected=true]:text-accent-foreground cursor-default data-[disabled=true]:pointer-events-none select-none',
      className
    )}
    {...props}
  />
